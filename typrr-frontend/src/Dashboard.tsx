...
export default function Dashboard() {
  ...
  return (
    <div className="mt-8 space-y-6">
      ...
      {/* Streak */}
      <div className="p-6 rounded-2xl bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20 border border-orange-200 dark:border-orange-800">
        ...
        <div>
          ...
          <div className="mt-4 space-y-2">
            {languageStats.map((stat) => (
              <div
                key={stat.language}
                className="p-3 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-between"
              >
                <div>
      ...
      <div>
        ...
        <div className="space-y-2">
          {recentHistory.map((entry) => (
            <div
              key={entry.id}
              className="p-3 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-between text-sm"
            >
